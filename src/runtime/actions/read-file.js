...
export default {
  type: 'read_file',
  intent: 'read_file',
  description: 'Read a file\'s contents. Returns the text with line numbers. Fields: "path" (file path), optional "offset" (start line, 1-based), optional "limit" (number of lines). If path is a directory, lists its contents. Returns: { success, content, totalLines, path }',
  ...
  async execute(action, agent) {
    ...
    const limit = action.limit || allLines.length;
