...
PromptDecl
  = exported:("export" _)? "prompt" _ name:Identifier _ params:PromptParams? _ "=" _ content:(ComposeDecl / StringLiteral) _ {
      return {
        type: 'PromptDecl',
        exported: !!exported,
        name,
...
RulesEntry
  = "rules" _ ":" _ content:StringLiteral {
      return { type: 'RulesEntry', value: content.value };
    }
